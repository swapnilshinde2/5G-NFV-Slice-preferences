...
load('GA_Data_new', 'delayUP_GA','delayCP_GA','LayerCP_GA','Adata_GA', 'CoSt_GA', 'DFrate', 'maxdup','maxdcp','Cp', 'Z')
...
subplot(2,2,3);
p2=semilogx(DFrate(1,z), delayUP_MPA(3,z), 'b-^',DFrate(1,z), delayUP_MMPA(3,z), 'g-o',DFrate(1,z), delayUP_GA(3,z), 'm-d',DFrate(1,z), delayUP_ESA(3,z), 'c-s',DFrate(1,z), maxdup(1,z,3),'r-p')
xlabel('Data Rate [Gb/sec]'), ylabel('Latency [msec]'),
xticks([200 500 1000 1200 1500 1800 2000])
xticklabels({'0.2','0.5','1','1.2','1.5','1.8','2'})
grid on
...
figure
subplot(2,2,1);
p2=semilogx(DFrate(1,z), delayCP_MPA(1,z), 'b-^',DFrate(1,z), delayCP_MMPA(1,z), 'g-o',DFrate(1,z), delayCP_GA(1,z), 'm-d',DFrate(1,z), delayCP_ESA(1,z), 'c-s',DFrate(1,z), maxdcp(1,z,1),'r-p')
xlabel('Data Rate [Gb/sec]'), ylabel('Latency [msec]'),
xticks([200 500 1000 1200 1500 1800 2000])
xticklabels({'0.2','0.5','1','1.2','1.5','1.8','2'})
grid on
...
subplot(2,2,2);
p2=semilogx(DFrate(1,z), delayCP_MPA(2,z), 'b-^',DFrate(1,z), delayCP_MMPA(2,z), 'g-o',DFrate(1,z), delayCP_GA(2,z), 'm-d',DFrate(1,z), delayCP_ESA(2,z), 'c-s',DFrate(1,z), maxdcp(1,z,2),'r-p')
xlabel('Data Rate [Gb/sec]'), ylabel('Latency [msec]'),
xticks([200 500 1000 1200 1500 1800 2000])
xticklabels({'0.2','0.5','1','1.2','1.5','1.8','2'})
grid on
...
subplot(2,2,3);
p2=semilogx(DFrate(1,z), delayCP_MPA(3,z), 'b-^',DFrate(1,z), delayCP_MMPA(3,z), 'g-o',DFrate(1,z), delayCP_GA(3,z), 'm-d',DFrate(1,z), delayCP_ESA(3,z), 'c-s',DFrate(1,z), maxdcp(1,z,3),'r-p')
xlabel('Data Rate [Gb/sec]'), ylabel('Latency [msec]'),
xticks([200 500 1000 1200 1500 1800 2000])
xticklabels({'0.2','0.5','1','1.2','1.5','1.8','2'})
grid on
...
xlabel('Data Rate [Gb/sec]'), ylabel('L3 [TB]'),
