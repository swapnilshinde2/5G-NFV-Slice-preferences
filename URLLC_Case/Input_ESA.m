function [F,Fup, Fcp, S, La, P, u, U,Actf,U_t,L_s,r_s,L_c,maxdup,maxdcp,K,Cp,Ol,t0,dels,Dtup,Dtcp,deltup,eta1,eta, ipdr, DLatency] =Input_ESA(z)
...
Cp=3*0.25*[3*10^12 5*10^12 5*10^12 12*10^12 18*10^12 20*10^12];
